...
class _CameraPageState extends State<CameraPage>
  ...
  // Key to force rebuild camera when returning from navigation
  ...
  void _navigateToSettings() async {
    ...
    if (mounted) {
      ...
      // Force camera rebuild with new key to reinitialize session
      setState(() {
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    switch (state) {
      ...
      case AppLifecycleState.inactive:
        // Camera will be automatically paused by camerawesome
        break;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        child: Stack(
          children: [
            // Wrap CameraAwesomeBuilder with Key to force rebuild
            CameraAwesomeBuilder.awesome(
              // key: _cameraKey, // Add this key to force rebuild
              ...
              sensorConfig: SensorConfig.single(
                sensor: Sensor.position(_currentCamera), // Use state variable
...
// Capture Button with normal loading indicator
